    ...
    <nav class="navbar navbar-custom navbar-static-top" role="navigation" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextPath}/index">Quality Software Technologies</a>
            </div>
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:864px">
	     <p style="text-align:justify;">
                    Quality Software Technologies is a premier IT training institute in Mumbai, offering hands-on courses in software development, testing, data science, and more.
                </p>
                <p style="text-align:justify;">
                  With expert instructors, flexible schedules, and job placement support, they empower individuals and businesses to excel in the tech industry.
                </p>
                <p><strong>Address:</strong> Prestige Chambers Thane-west mumbai 400601</p>
                <p><strong>Phone:</strong> +91-8108421781</p>
                <p><strong>Email:</strong> info@qualitysoftech.com</p>
  	</div>
   </div>
